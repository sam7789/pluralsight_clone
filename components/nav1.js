  ...
  return `
        <div id="platform">
            ...
            <div class="box">
                ...
                <img src="https://www.pluralsight.com/content/dam/pluralsight2/experiment-fragment/navigation/iq.png"
                    alt="">
                <p><a href="./skill-iq.html">Skill assessments</a></p>
                </div>
                <div>
            ...
            <div>
                ...
                <div>
                <div class="flex">
                    <img src="https://pluralsight2.imgix.net/paths/images/group-policy-administration-ee0dacafe8.png?w=75"
                    alt="">
                    <div class="padding10">
                ...
                <div class="flex">
                    <img src="https://pluralsight2.imgix.net/paths/images/aws-certified-devops-engineer-25d912e3da.png?w=75"
                    alt="">
                    <div class="padding10">
                    <p>AWS Operations</p>
        ...
        <div id="navResources">
            ...
            <div>
                ...
                <div class="popupImg">
                <img
                    src="https://www.pluralsight.com/content/experience-fragments/pluralsight/Navigation/global-nav/master/jcr:content/root/navigation/main/nav_item_dropdown_1789622253/parsys/nav_resource/parsys/generic_block/parsys/generic_block/image-res.img.b9432c42-7520-4638-adfb-7f187be8e766.png"
                    alt="">
                <div class="fcolor">
                    <h1>The ultimate playbook<br /> on Technology Skill<br /> Development</h1>
                    <h3 class="fontWeight100">IMPLEMENT THE STRATEGY FOR <br /> BUILDING BETTER TEAMS</h3>
        ...
        <div id="navSkills">
            ...
            <div class="">
                ...
                <div>
                    ...
                    <p><a href="./skills.html">Build tech skills to drive results</a></p>
                </div>
                <hr>
                <div>
                    <h4><a href="./skills.html">What is Skills?</a></h4>
                ...
                <div>
                    ...
                    <p><a href="./flow.html">Get insights into your workflow</a></p>
                </div>
                <hr>
                <div>
                    <h4><a href="./flow.html">What is Flow?</a></h4>
